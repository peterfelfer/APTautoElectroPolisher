...
def detect_thinnest_section(img_path: str, show_plots: bool = True):
    """
    Detect the thinnest horizontal cross-section of a vertically oriented bar.

    Args:
        img_path: Path to the microscope image file.
        show_plots: If True, renders diagnostic plots using matplotlib.

    Returns:
        Dict with minimum width details and binary mask.
    """
    # --- 1) Load grayscale
